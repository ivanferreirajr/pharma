...
INSERT INTO USUARIO (EMAIL, SENHA, NOME, DATA_NASC, ID_CARTEIRA, TIPO_CLIENTE, TIPO_FARMACEUTICO, TIPO_ENTREGADOR) VALUES
('JOAOFREITAS@GMAIL.COM','JOAO123','JOAO FREITAS','1978-05-21','13', FALSE, TRUE, FALSE),
('FERNANDOGOMES@GMAIL.COM','FERNANDO123','FERNANDO GOMES','1985-12-02','14', FALSE, TRUE, FALSE),
('MARCOSFERNANDO@GMAIL.COM','MARCOS123','MARCOS FERNANDO','1990-10-02','15', TRUE, FALSE, FALSE),
('JOSEMARIANO@GMAIL.COM','JOSE123','JOSE MARIANO','1980-12-01','1', FALSE, TRUE, FALSE),
('CARLOSSANTANA@GMAIL.COM','CARLOS123','CARLOS SANTANA','1990-12-10','2', TRUE, FALSE, FALSE),
('CARLOSALBERTO@GMAIL.COM','CARLOS1234','CARLOS ALBERTO','1985-05-21','3', FALSE, FALSE, TRUE),
('LUCASDOSSANTOS@GMAIL.COM','LUCAS123','LUCAS DOS SANTOS','1991-03-09','9', FALSE, FALSE, TRUE),
('MARIANAFARIAS@GMAIL.COM','MARIANA123','MARIANA FARIAS','1995-04-21','10', FALSE, FALSE, TRUE),
('CAIODOCEU@GMAIL.COM','CAIO123','CAIO DO CÉU','1992-01-31','11', FALSE, FALSE, TRUE),
('MARCOSSANTANA@GMAIL.COM','MARCOS123','MARCOS SANTANA','1998-12-01','12', FALSE, FALSE, TRUE),
('ANDREGOMES@GMAIL.COM','ANDRE123','ANDRÉ GOMES','1990-10-21','4', TRUE, FALSE, FALSE);
...
('102.00',NULL, 2, '2047247641','78854875155','04242472044242','2019-08-24'), --2
('85.47','1', 3, '2047247641','78854875155','21457801245784','2019-08-29'), --3
('35.10','2', 5, '0258741258','35679754123','04242472044242','2019-07-17'), --4
('15.25','3', 6, '3225067642','35679754123','23430746119734','2019-08-15'), --5
('505.05','4', 7, '0258741258','02154842102','21457801245784','2019-07-20'), --6
('47.55','5', 9, '0215484121','02154842102','31246597887542','2019-08-23'), --7
('68.99','6', 15, '1245707427','02154842102','21457801245784','2019-08-21'); --8
